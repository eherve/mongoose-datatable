        ...
        return this.each(function () {
            ...
            for (j = 0; j < aiCustomSearch_Indexes.length; j++) {
                ...
                var fnSearch_ = function (index) {
                    return $("#" + sTableId + "range_from_" + index).val() + properties.sRangeSeparator + $("#range_to_" + index).val()
                }
            ...
            if (oTable.fnSettings().oFeatures.bServerSide) {
                ...
                oTable.fnSettings().fnServerData = function (sSource, aoData, fnCallback, oSettings) {
